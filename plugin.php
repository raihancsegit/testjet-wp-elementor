...
class Plugin {
	...
	private function include_widgets_files() {
		...
		require_once( __DIR__ . '/widgets/fetures-tab.php' );
	...
	public function register_widgets() {
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Widgets\Fetures() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Widgets\Logo() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Widgets\Integration() );
