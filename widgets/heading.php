...
class Heading extends Widget_Base {
	...
	public function get_title() {
		return __( 'Heading', 'elementor-hello-world' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Our Features', 'elementor-hello-world' ),
			]
		);
	...
	protected function render() {
		...
		ob_start();
        ?>
        <h2 class="feture-title"><?php echo $settings['title'];?></h2>
        <p class="feture-sub"><?php echo $settings['sub_title'];?></p>
